...
//                playlistButton.backgroundColor = .systemGreen       // seçime göre butonun komple rengini değiştirmek için
//                albumsButton.backgroundColor = .clear
                
            case .album:
                indicatorView.frame = CGRect(x: playlistButton.width, y: playlistButton.bottom, width: 100, height: 3)
//                playlistButton.backgroundColor = .clear            // seçime göre butonun komple rengini değiştirmek için
